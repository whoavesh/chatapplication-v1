...
$c = 'We are currently on beta stage, where we try some new feature and Fix bug issues.';
...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
  ...
  <form action="../php/login.php" method="POST" enctype="multipart/form-data" autocomplete="on" class="form login mx-auto mt-8 mb-0 max-w-md space-y-4">
    ...
    <p class="text-sm text-gray-500">
        <a class="underline" href="auth.php?auth=forgetpassword">Forget Password</a>
      </p>
  </form>
</div>